...
<div class="col-lg-12 col-md-12">
    <div class="panel panel-white">
        ...
        <table id="example" class="display table" >
                ...
                <tbody>
                <?php if (!empty($LetterLogs)) {
                   foreach ($LetterLogs as $values) {?>
                    <tr> <td><?php
                             if (!empty($Staff)) {
                        ...
                        <td><a href="<?php echo base_url();?>kpitb_panel/ViewHistory/<?php echo $values->id;?>" class="btn btn-success btn-xs"> <i class="fa fa-book"> </i> History</a></td>
                        <td>
